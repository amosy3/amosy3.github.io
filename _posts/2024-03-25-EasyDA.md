...
<p align="center">
  <img src="_posts/2024-03-05-EasyDA-figs/post-fig1.pdf" width="450" />
</p>

<c> In domain adaptation, the training process involves using data from the source domain, while evaluation occurs on a distinct but related target domain. (Images are from DomainNet dataset)</c>
